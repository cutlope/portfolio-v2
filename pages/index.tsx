    ...
    <div className='pl-3'>
      ...
      <div className='flex flex-col'>
        ...
        <div className='mt-6 flex flex-col gap-y-5'>
          ...
          <Link href='/projects'>
            <a className='group mt-2 flex items-center justify-start space-x-2 text-xl font-medium dark:text-white'>
        ...
        <div className='my-10 flex flex-col gap-y-5 '>
          ...
          <Link href='/projects'>
            <a className='group flex items-center justify-start space-x-2 text-xl font-medium dark:text-white'>
